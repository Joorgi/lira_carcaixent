...
class Partitura
{
    ...
    #[ORM\ManyToOne(targetEntity:Pieza::class)]
    #[ORM\JoinColumn(name: 'ID_PIEZA', referencedColumnName: 'ID', nullable: false)]
    private $idPieza;
    ...
    public function getIdPieza(): ?Pieza
    {
        return $this->idPieza;
    }

    public function setIdPieza(?Pieza $idPieza): self
    {
