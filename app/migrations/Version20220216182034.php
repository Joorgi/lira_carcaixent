 ...
 */
final class Version20220216182034 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (ID INT AUTO_INCREMENT NOT NULL, EMAIL VARCHAR(180) NOT NULL, ROLES LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PASSWORD VARCHAR(255) NOT NULL, ID_MUSICO INT DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D64910C6BEC4 (EMAIL), UNIQUE INDEX UNIQ_8D93D6493483FB76 (ID_MUSICO), PRIMARY KEY(ID)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
